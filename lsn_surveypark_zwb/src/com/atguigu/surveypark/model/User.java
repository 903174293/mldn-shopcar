...
public class User extends BaseEntity{
	...
	private static final long serialVersionUID = -937431684972462183L;
	private Integer id;
	...
	// 权限总和
	private long[] rightSum;//这里使用基本类型，不适用包装类，原因：数组开辟之后，默认值为0
	...
	public void calculateRightSum() {
		...
		// 释放资源：这一步非常关键，防止session资源占用量太大------------------------只存用户对象，角色和权限不会存到session之中
		roles = null;
	}
